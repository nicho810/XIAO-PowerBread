...
- **Utiliser directement le firmware compilé** : Actuellement, le code n'est testé que sur XIAO RP2040, il est recommandé d'utiliser la méthode UF2 pour télécharger le firmware sur XIAO RP2040.
