...
#ifndef _XPB_ST7735H_
#define _XPB_ST7735H_

// #include <Adafruit_ST77xx.h>
#include "XPB_ST77xx.h"
/*
This code is a modified version of the Adafruit_ST7735 library for the XIAO-PowerBread.
Some definitions are changed to fit the XIAO-PowerBread's hardware(The tft lcd used on XIAO-PowerBread).
*/
